   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<button class="btn btn-blue-grey" id="cancelDateTimeButton">' + this.params.cancelText + '</button>' +
                         '<button class="btn btn-light-green" id="okDateTimeButton">' + this.params.okText + '</button>' +
                         '<div class="clearfix"></div>' +
                         '</div>' +
                         '</div>' +
                         '</div>';
              ...
              {
                 this._attachEvent(this.$dtpElement.find('#cancelDateTimeButton'), 'click', this._onCancelClick.bind(this));
                 this._attachEvent(this.$dtpElement.find('#okDateTimeButton'), 'click', this._onOKClick.bind(this));
